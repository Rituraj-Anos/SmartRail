...
class MILPSolver:
    ...
    """
    def __init__(self, section: Section, horizon_minutes: int = 60, timeout_sec: float = 3.0):
    ...
    def solve(
        ...
        for train in trains:
            d[train.train_id] = model.NewIntVar(0, self.horizon_minutes, f"d_{train.train_id}")
        ...
        for s in B:
            ...
            for t in T:
                ...
                window_end = min(t + self.min_headway_min, self.horizon_minutes) if s in B_track else t + 1
